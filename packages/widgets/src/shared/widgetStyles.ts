...
export const ROW_CONTAINER = 'inline-flex flex-row items-center px-2 py-1.5 rounded border border-gray-200 bg-white self-start';
...
export const UNIT_CLASS = `${COL.unit} text-xs text-gray-900 text-center`;
