...
describe('buildGatedFetchTile — CLIENT_UNDER_RANGE', () => {
  it('live-spine span < MIN_VIEWPORT_SPAN_MS rejects with CLIENT_UNDER_RANGE', async () => {
    const gated = buildGatedFetchTile();
  ...
  it('normal viewport span calls fetchTile', async () => {
    const gated = buildGatedFetchTile();
...
describe('buildGatedFetchTile — CLIENT_OVER_RANGE', () => {
  it('bucketS > MAX_BUCKET_S rejects with CLIENT_OVER_RANGE', async () => {
    const gated = buildGatedFetchTile();
...
describe('buildGatedFetchTile — CLIENT_PRE_EPOCH', () => {
  it('startTime < 0n rejects with CLIENT_PRE_EPOCH', async () => {
    const gated = buildGatedFetchTile();
