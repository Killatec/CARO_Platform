...
const SIGNALS_TH: CSSProperties = {
  padding: `6px ${CELL_PAD_PX}px`,
  background: '#f9fafb',
...
const SIGNALS_TH_INNER: CSSProperties = {
  display: 'flex',
  alignItems: 'center',
  ...
  return (
    <div style={STRIP}>
      ...
      <table style={TABLE_STYLE}>
        ...
        <thead>
          <tr>
            <th colSpan={5} scope="colgroup" style={SIGNALS_TH}>
              <div style={SIGNALS_TH_INNER}>
