...
interface MetaModalBodyProps {
  meta: MetaEntry[] | undefined | null;
  dbMeta?: MetaEntry[] | undefined | null;
}
 ...
 */
export function MetaModalBody({ meta, dbMeta }: MetaModalBodyProps): React.ReactElement {
    ...
    <>
      ...
      <ol className="space-y-4 list-none p-0">
        {meta.map((entry, i) => {
          ...
          const dbFields: Record<string, unknown> = dbEntry?.fields ?? {};
          const proposedFields: Record<string, unknown> = entry.fields ?? {};
