 ...
 */
export function ValidationPanel({ messages = [] }: ValidationPanelProps): React.ReactElement {
  ...
  return (
    <div className="bg-white border-t border-gray-200 max-h-[50vh] flex flex-col">
      <div className="flex-shrink-0 px-3 py-2 text-xs font-semibold text-gray-400 uppercase tracking-wide border-b border-gray-100">
        Validation
      </div>
