...
interface FieldValueRowProps extends React.HTMLAttributes<HTMLDivElement> {
  fieldName: string;
  value: unknown;
  dataType?: string;
  isOverride?: boolean;
...
export function FieldValueRow({
  fieldName, value, dataType: _dataType, isOverride = false, onChange, onDelete,
  readOnly = false, className = '', ...props
}: FieldValueRowProps): React.ReactElement {
